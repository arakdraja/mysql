...
Parser.prototype._tryReadCompressedPacketHeader = function _tryReadCompressedPacketHeader() {
  ...
  if (this._compressedPacketHeader.sequence !== this._nextCompressedPacketNumber) {
    var err = new Error(
      'Compressed packets out of order. Got: ' + this._compressedPacketHeader.sequence + ' ' +
      'Expected: ' + this._nextCompressedPacketNumber
    );
  ...
  this.incrementCompressedPacketNumber();
